...
public class FractalOrganic : MonoBehaviour
{
    ...
    void OnEnable() {
        ...
        sequenceNumbers = new float4[depth];
        ...
        for (int i = 0, length = 1; i < parts.Length; i++, length *= 5) {
            ...
            sequenceNumbers[i] = new float4(Random.value, Random.value, Random.value, Random.value);
